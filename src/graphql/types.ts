...
export type CollectionLocation = Node &
  CollectionItem & {
...
export type ItineraryCollection = Node &
  ItineraryItem & {
...
export type ItineraryDirections = Node &
  ItineraryItem & {
...
export type ItineraryLocation = Node &
  ItineraryItem & {
...
export type AuthorizedProfilesQueryVariables = Exact<{ [key: string]: never }>;

export type AuthorizedProfilesQuery = { __typename?: "Query" } & {
  authorizedProfiles: { __typename?: "ProfileConnection" } & {
    nodes: Array<{ __typename?: "Profile" } & Pick<Profile, "id" | "name">>;
  };
};
...
export type PlaceOpeningHoursQuery = { __typename?: "Query" } & {
  place?: Maybe<
    { __typename: "Place" } & Pick<Place, "id"> & {
        hours?: Maybe<
          { __typename?: "PlaceHours" } & Pick<PlaceHours, "osmTag"> & {
              intervals: { __typename?: "PlaceHoursIntervalConnection" } & {
                nodes: Array<
                  { __typename?: "PlaceHoursInterval" } & Pick<
                    PlaceHoursInterval,
                    "from" | "to" | "status" | "comment"
                  > & {
                      fromToday: PlaceHoursInterval["from"];
                      fromNextDay: PlaceHoursInterval["from"];
                      toTime: PlaceHoursInterval["to"];
                      relative: PlaceHoursInterval["from"];
                    } & {
                      publicHolidays: Array<
                        { __typename?: "PlaceHoursIntervalHoliday" } & Pick<
...
export const AuthorizedProfilesDocument = gql`
  query AuthorizedProfiles {
    authorizedProfiles(first: 5) {
      nodes {
        id
        name
      }
 ...
 * });
 */
export function useAuthorizedProfilesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AuthorizedProfilesQuery,
    AuthorizedProfilesQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    AuthorizedProfilesQuery,
    AuthorizedProfilesQueryVariables
  >(AuthorizedProfilesDocument, options);
}
export function useAuthorizedProfilesLazyQuery(
...
export type AuthorizedProfilesQueryHookResult = ReturnType<
  typeof useAuthorizedProfilesQuery
>;
export type AuthorizedProfilesLazyQueryHookResult = ReturnType<
  typeof useAuthorizedProfilesLazyQuery
>;
export type AuthorizedProfilesQueryResult = Apollo.QueryResult<
  AuthorizedProfilesQuery,
  AuthorizedProfilesQueryVariables
>;
 ...
 * });
 */
export function usePlaceOpeningHoursQuery(
  baseOptions: Apollo.QueryHookOptions<
    PlaceOpeningHoursQuery,
    PlaceOpeningHoursQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    PlaceOpeningHoursQuery,
    PlaceOpeningHoursQueryVariables
  >(PlaceOpeningHoursDocument, options);
}
export function usePlaceOpeningHoursLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PlaceOpeningHoursQuery,
    PlaceOpeningHoursQueryVariables
  >
...
export type PlaceOpeningHoursQueryHookResult = ReturnType<
  typeof usePlaceOpeningHoursQuery
>;
export type PlaceOpeningHoursLazyQueryHookResult = ReturnType<
  typeof usePlaceOpeningHoursLazyQuery
>;
export type PlaceOpeningHoursQueryResult = Apollo.QueryResult<
  PlaceOpeningHoursQuery,
  PlaceOpeningHoursQueryVariables
>;
